...
useEffect(() => {
  ...
  const results = HomesArray.filter((houses)=>houses.property_spec.toLowerCase()===type.toLowerCase());
  ...
  return (
    <div>
      ...
      <div className="listing-container">
       {type === 'all' ?arrayNew.map((item, index) => {
         
          return (
            <div className="list-box" key={index}>
              <div className="image1-container">
                <img key={index} className="image1" src={item.image1} alt="" />
      ...
      <div className="homelisting-footer"><FooterList/></div>

<Link to={'/map'}><div className="map-btn"><MapButton /></div></Link>
